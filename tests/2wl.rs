...
fn simplest() {
    ...
    assert_eq!(
        wl_isomorphism::invariant_2wl(g),
        wl_isomorphism::invariant_2wl(g2)
    );
}
#[test]
fn simple_fail() {
...
fn different_iterations() {
    ...
    assert_ne!(
        wl_isomorphism::iter_2wl(g.clone(), 2),
        wl_isomorphism::iter_2wl(g, 3)
    );
}
#[test]
fn equivalence_hardcoded_stabilisation() {
    ...
    assert_eq!(
        wl_isomorphism::iter_2wl(g.clone(), 3),
        wl_isomorphism::invariant_2wl(g)
    );
}
...
fn extra_expressive() {
    ...
    assert_ne!(
        wl_isomorphism::invariant_2wl(two_cycles),
        wl_isomorphism::invariant_2wl(big_cycle)
    );
}
